...
- **`npm test` before you push.** 319 tests, no Azure needed, about 20 seconds. `node scripts/bootstrap.js --dry-run` validates content changes the same way, and `node scripts/sample-data.js --list` shows what the generator would produce.
